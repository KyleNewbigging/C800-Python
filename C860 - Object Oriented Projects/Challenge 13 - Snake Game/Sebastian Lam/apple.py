...
class Apple:
    ...
    def randomize(self):
        self.x_position = random.randint(int(Config["game"]["bumper_size"])*1.5,int(Config["game"]["width"])-int(Config["game"]["bumper_size"])*1.5)
        self.y_position = random.randint(int(Config["game"]["bumper_size"])*1.5,int(Config["game"]["height"])-int(Config["game"]["bumper_size"])*1.5)
    def get_rect(self):
